...
//        p('A JavaScript library that controls value assignment using callback functions.'),
    ...
    bb.test(valk.count(), [
        ...
        (t)=>0===t._start,
        (t)=>Infinity===t._end,
        (t)=>valk.types.Counter.onCompletedTypes.Over===t._onCompletedType,
    ])
    ...
    bb.test(valk.count({type:valk.types.Counter.onCompletedTypes.Error}), [
        (t)=>console.log(t),
        (t)=>1===t.v,
        (t)=>1===t._v,
        (t)=>1===t._start,
        (t)=>0===t._end,
        (t)=>valk.types.Counter.onCompletedTypes.Error===t._onCompletedType,
    ])
    a.fin()
});
