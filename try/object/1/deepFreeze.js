...
Object.deepFreeze = function(obj, isSealLeaf=false) { // isSealLeaf: 末端Objはfreezeでなくsealにする
    ...
    for (let [k,v] of Object.entries(obj)) {
        if ('Object'===v.constructor.name) { obj[k] = Object.deepFreeze(v, isSealLeaf); hasChildren = true; }
    }
    console.log(obj, hasChildren, isSealLeaf, hasChildren || !isSealLeaf ? 'freeze' : 'seal')
...
Object.deepSeal = function(obj, isPreventExtensionsLeaf=false) { // isSealLeaf: 末端ObjはsealでなくpreventExtensionsにする
    let hasChildren = false
    for (let [k,v] of Object.entries(obj)) {
        if ('Object'===v.constructor.name) { obj[k] = Object.deepSeal(v, isPreventExtensionsLeaf); hasChildren = true; }
    }
