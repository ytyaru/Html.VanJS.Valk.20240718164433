...
class FixObj extends Fix {
    obj(o, level='val', withoutChildren=false, leafLevel='key') { // level: 'val' or 'key'
        ...
        if (withoutChildren) { return super[level](obj) }
        else { return this._recursion(o, level) }
    }
    _recursion(obj) {
        ...
        return super[hasChildren ? this._level : this._leafLevel](obj)
