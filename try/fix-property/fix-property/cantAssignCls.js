...
function cantAssignCls(cls, context=null) {
    ...
    */
//    if (!Type.isCls(cls)) { return cls }
    //if (!(('function'===typeof v) && (!!v.toString().match(/^class /)))) { return cls }
    if (!(('function'===typeof cls) && (!!cls.toString().match(/^class /)))) { throw new TypeError(`引数はクラスであるべきです。`) }
    const P = cantAssign(cls, {construct(target, args) {return cantAssign(new target(...args))}})
